...
public class TemplateService extends BaseService {
	...
	public List<TbFolderRollPicture> rollPicture(int folderId,int position) {
		return service.getRollPicture(folderId,position);
	}

	public List<TbRecruitingTrip> recruitingTrip(int folderId) {
		return service.getRecruitingtrip(folderId);
	}
	
	public TbFolderRollPicture returnImageorText(String identify,int folderId){
		return service.returnImageorText(identify,folderId);
	}
